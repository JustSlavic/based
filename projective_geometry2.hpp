...
line2 make_line2(float32 a, float32 b, float32 c)
{
    line2 result;
    result._e1 = a;
    result._e2 = b;
...
point2 make_point2(float32 x, float32 y)
{
    point2 result;
    result.w = 1.f;
    result.x = x;
...
point2 to_point2(motor2 m)
{
    point2 result = m.point2;
    return result;
}

line2 to_line2(flector2 f)
{
...
motor2 operator * (motor2 m1, motor2 m2)
{
    ...
    // (t1t2 - w1w2) _1
    // (t1x2 + x1t2 - y1w2 + w1y2) e20
    // (t1y2 + x1w2 + y1t2 - w1x2) e01
    // (t1w2 + w1t2) e12
    motor2 result;
